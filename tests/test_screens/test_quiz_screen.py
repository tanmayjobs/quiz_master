...
class TestQuizScreen:
    def test_play_screen_negative(self, mock_quiz):
        with patch(
            "src.handler.questions.QuestionHandler.get_quiz_questions"
        ) as mocked_questions:
    ...
    def test_play_screen_positive(self, mock_quiz, monkeypatch):
        with patch.object(QuizScreen, "play_quiz") as mocked_screen:
            ...
            with patch(
                "src.screens.quiz_screen.QuestionHandler.get_quiz_questions"
            ) as mocked_questions:
