...
class PlayService:
    ...
    def play(self, questions, answers):
        ...
        question_correct_options = {
            question[Strings.QUESTION_ID]: {option for option in question[Strings.OPTIONS] if option[Strings.IS_CORRECT]}
        ...
        for answer in answers:
            ...
            each_question_score =  (len(correct_selected) - len(incorrect_selected)) / len(questions[answer[Strings.QUESTION_ID]][Strings.OPTIONS])
